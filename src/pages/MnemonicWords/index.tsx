    ...
    <div className="MnemonicWords flex flex-col">
      <div className="w-full">
        ...
        <div className="flex items-center relative">
          <textarea className="border rounded h-16 w-full resize-none text-gray-700 mt-3 py-1 px-1 pr-16 leading-tight focus:outline-none" placeholder="Mnemonic Words..." value={words + "\n" + bip32Address}></textarea>
          <button className="absolute right-2 bg-blue-400 hover:bg-blue-600 text-white text-sm font-bold py-2 px-2 rounded disabled:opacity-50" type="button" onClick={() => copyToClipboard(words)}>
            <svg className="h-5 w-5 text-white"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <rect x="8" y="8" width="12" height="12" rx="2" />  <path d="M16 8v-2a2 2 0 0 0 -2 -2h-8a2 2 0 0 0 -2 2v8a2 2 0 0 0 2 2h2" /></svg>
          </button>
        </div>
      </div>
    </div>
